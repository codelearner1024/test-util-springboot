...
////            pageMap.put("SigningDate", "签单日期："+StringUtils.formatDateTimeCN(StringUtils.dateTimeFormat(contract.getSigningDate())));
////            pageMap.put("Phone", "电    话：" + oProduct.getFactory().getPhone());
////            pageMap.put("InputBy", "制单：" + contract.getInputBy());
////            pageMap.put("CheckBy", "审单："+ StringUtils.fixSpaceStr(contract.getCheckBy(),26)+"验货员："+StringUtils.convertNull(contract.getInspector()));
////            pageMap.put("Remark", "  "+StringUtils.convertNull(contract.getRemark()));
////            pageMap.put("Crequest", "  "+StringUtils.convertNull(contract.getCrequest()));
////
...
////
////            //插入产品图片
////            if(StringUtils.isNotEmpty(printMap.get("ProductImage"))){
...
////
////
////            if(contract.getPrintStyle().equals("2") && StringUtils.isNotEmpty(printMap.get("ProductNo2"))){
////                nRow = sheet.createRow(curRow++);
////                nRow.setHeightInPoints(96);
////
////                region = new CellRangeAddress(curRow-1, curRow-1, 1, 3);    //纵向合并单元格
...
////
////                //插入产品图片
////                if(StringUtils.isNotEmpty(printMap.get("ProductImage2"))){
...
////
////                nCell = nRow.createCell(8);
////                if(StringUtils.isNotEmpty(printMap.get("Cnumber2")) && StringUtils.isNotEmpty(printMap.get("Price2"))){
////                    nCell.setCellType(HSSFCell.CELL_TYPE_FORMULA);
////                    nCell.setCellFormula("F"+String.valueOf(curRow)+"*H"+String.valueOf(curRow));
////                }
////                nCell.setCellStyle(poiUtil.moneyrv10_BorderThin(wb, defaultFont10, rmb4Format));
